...
import com.github.paohaijiao.code.JTriggerOn;
...
@Getter
@Setter
public class JTooltip extends JBasic<JTooltip> implements JComponent {
    /**
     ...
     * 坐标轴指示器，坐标轴触发有效
     */
    private JAxisPointer axisPointer;
    /**
     * 文本样式，默认为白色字体
     *
     * @see JTextStyle
    ...
    public JTooltip alwaysShowContent(Boolean alwaysShowContent) {
    ...
    public JTooltip triggerOn(JTriggerOn triggerOn) {
     ...
     * @param axisPointer
     */
    public JTooltip axisPointer(JAxisPointer axisPointer) {
     ...
     * @param textStyle
     */
    public JTooltip textStyle(JTextStyle textStyle) {
     ...
     * @param showContent
     */
    public JTooltip showContent(Boolean showContent) {
     ...
     * @param trigger
     */
    public JTooltip trigger(JTrigger trigger) {
     ...
     * @param position
     */
    public JTooltip position(Object position) {
     ...
     * @param position
     */
    public JTooltip position(JPosition position) {
        this.position = position;
        return this;
    }
     ...
     * @param formatter
     */
    public JTooltip formatter(Object formatter) {
     ...
     */
    public JTooltip islandFormatter(String islandFormatter) {
     ...
     * @param showDelay
     */
    public JTooltip showDelay(Integer showDelay) {
     ...
     * @param hideDelay
     */
    public JTooltip hideDelay(Integer hideDelay) {
     ...
     */
    public JTooltip transitionDuration(Double transitionDuration) {
     ...
     * @param enterable
     */
    public JTooltip enterable(Boolean enterable) {
     ...
     * @param borderRadius
     */
    public JTooltip borderRadius(Integer borderRadius) {
     ...
     * 坐标轴指示器，坐标轴触发有效
     */
    public JAxisPointer axisPointer() {
        if (this.axisPointer == null) {
            this.axisPointer = new JAxisPointer();
        }
