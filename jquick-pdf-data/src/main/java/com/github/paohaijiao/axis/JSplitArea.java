...
import com.github.paohaijiao.style.JAreaStyle;
...
@Getter
@Setter
public class JSplitArea implements java.io.Serializable {
     ...
     * @param show
     */
    public JSplitArea show(Boolean show) {
        this.show = show;
        return this;
    }
     ...
     * @param areaStyle
     */
    public JSplitArea areaStyle(JAreaStyle areaStyle) {
