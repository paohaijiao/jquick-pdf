...
public class JQuickPDFParser extends Parser {
	...
	public static final int
		...
		COLON=53, SEMICOLON=54, DEFAULT=55, EXECUTIVE=56, LEDGER=57, LEGAL=58, 
		LETTER=59, TABLOID=60, AUTO=61, DOCTYPE=62, NUMBER=63, UNIT=64, IDENTIFIER=65, 
		STRING=66, WS=67, COMMENT=68, AT=69, TEXT=70;
	public static final int
		...
		RULE_number = 35, RULE_unit = 36, RULE_variable = 37;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"attr", "key", "value", "string", "number", "unit", "variable"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'%'", "'${'", "':'", "';'", "'DEFAULT'", "'EXECUTIVE'", "'LEDGER'", 
			"'LEGAL'", "'LETTER'", "'TABLOID'", "'auto'", "'<!DOCTYPE html>'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, "COLON", "SEMICOLON", "DEFAULT", "EXECUTIVE", 
			"LEDGER", "LEGAL", "LETTER", "TABLOID", "AUTO", "DOCTYPE", "NUMBER", 
			"UNIT", "IDENTIFIER", "STRING", "WS", "COMMENT", "AT", "TEXT"
		};
	}
	...
	public final ParagraphContext paragraph() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 288769L) != 0)) {
				{
				setState(163);
				value();
				}
