...
import com.github.paohaijiao.model.css.JCSSPropertiesIModel;
 ...
 * @description
 */
public class JCSSPropertiesIProvider extends JCSSPropertiesBaseProvider {
    public static Style convertToStyle(JCSSPropertiesIModel css) {
