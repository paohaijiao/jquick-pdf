...
import com.github.paohaijiao.model.css.JCSSPropertiesQModel;
 ...
 * @description
 */
public class JCSSPropertiesQProvider extends JCSSPropertiesBaseProvider {
    public static Style applyCSSProperties(JCSSPropertiesQModel cssProperties) {
