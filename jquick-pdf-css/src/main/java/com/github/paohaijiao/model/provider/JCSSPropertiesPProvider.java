...
import com.github.paohaijiao.model.css.JCSSPropertiesPModel;
 ...
 * @description
 */
public class JCSSPropertiesPProvider extends JCSSPropertiesBaseProvider {
    public static Style convertToStyle(JCSSPropertiesPModel cssModel) {
    ...
    private static void applyPaddingProperties(Style style, JCSSPropertiesPModel cssModel) {
        // Apply shorthand padding first (may be overridden by specific padding properties)
...
//                    style.setProperty(Property.POSITION, com.itextpdf.layout.properties.PositionProperty.RELATIVE);
    ...
    private static float parseFloatValue(String value) {
        ...
        // Remove non-numeric characters (simple parsing, may need enhancement)
