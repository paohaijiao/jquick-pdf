 ...
 * @description
 */
public class JCSSPropertiesAProvider extends JCSSPropertiesBaseProvider {

    public static void applyCssProperties(BlockElement<?> element, JCSSPropertiesAModel cssProperties) {
