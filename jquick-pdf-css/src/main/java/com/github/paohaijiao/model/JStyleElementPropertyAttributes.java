...
public class JStyleElementPropertyAttributes extends HashMap<String, String> {
    ...
    public static final String fontFamilyNames = "fontFamilyNames";
    ...
    public static final String fontKerning = "fontKerning";
    ...
    public static final String splitCharacters = "splitCharacters";

    public static final String textRenderingMode = "textRenderingMode";
    ...
    public static final String baseDirection = "baseDirection";

    public static final String hyphenation = "hyphenation";

    public static final String fontScript = "fontScript";
